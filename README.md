...
```js
new GeminiModel(client, model, options = {})
```
...
```js
new GeminiContents(model, contents)
```
...
```js
new GeminiFunction(name, description, parameters = null, func)
```
